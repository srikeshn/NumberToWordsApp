...
public class NumberToWordsConverter {
	...
	private final Collection<? extends AbstractWordType> numberTypes = Arrays.asList(new TwoDigitsService(),
			new ThreeDigitsService(), new FourDigitsService(), new FiveDigitsService(), new SixDigitsService(), new SevenDigitsService(),
			new EightDigitsService(), new NineDigitsService());
